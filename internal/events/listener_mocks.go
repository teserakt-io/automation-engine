...
// Source: gitlab.com/teserakt/c2ae/internal/events (interfaces: StreamListenerFactory,StreamListener)
...
import (
	...
	pb0 "gitlab.com/teserakt/c2ae/internal/pb"
	reflect "reflect"
)
...
func (m *MockStreamListenerFactory) Create(arg0 int, arg1 ...pb0.EventType) StreamListener {
	m.ctrl.T.Helper()
...
// C mocks base method
func (m *MockStreamListener) C() <-chan pb.Event {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "C")
	ret0, _ := ret[0].(<-chan pb.Event)
	return ret0
}
...
func (m *MockStreamListener) onEvent(arg0 pb.Event) {
	m.ctrl.T.Helper()
