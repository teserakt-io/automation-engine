...
// Source: gitlab.com/teserakt/c2se/internal/models (interfaces: Converter)
...
import (
	...
	pb "gitlab.com/teserakt/c2se/internal/pb"
	reflect "reflect"
)
...
func (m *MockConverter) PbToRule(arg0 *pb.Rule) (models.Rule, error) {
	m.ctrl.T.Helper()
...
func (m *MockConverter) PbToRules(arg0 []*pb.Rule) ([]models.Rule, error) {
	m.ctrl.T.Helper()
...
func (m *MockConverter) PbToTarget(arg0 *pb.Target) (models.Target, error) {
	m.ctrl.T.Helper()
...
func (m *MockConverter) PbToTargets(arg0 []*pb.Target) ([]models.Target, error) {
	m.ctrl.T.Helper()
...
func (m *MockConverter) PbToTrigger(arg0 *pb.Trigger) (models.Trigger, error) {
	m.ctrl.T.Helper()
...
func (m *MockConverter) PbToTriggers(arg0 []*pb.Trigger) ([]models.Trigger, error) {
	m.ctrl.T.Helper()
...
func (m *MockConverter) RuleToPb(arg0 models.Rule) (*pb.Rule, error) {
	m.ctrl.T.Helper()
...
func (m *MockConverter) RulesToPb(arg0 []models.Rule) ([]*pb.Rule, error) {
	m.ctrl.T.Helper()
...
func (m *MockConverter) TargetToPb(arg0 models.Target) (*pb.Target, error) {
	m.ctrl.T.Helper()
...
func (m *MockConverter) TargetsToPb(arg0 []models.Target) ([]*pb.Target, error) {
	m.ctrl.T.Helper()
...
func (m *MockConverter) TriggerToPb(arg0 models.Trigger) (*pb.Trigger, error) {
	m.ctrl.T.Helper()
...
func (m *MockConverter) TriggersToPb(arg0 []models.Trigger) ([]*pb.Trigger, error) {
	m.ctrl.T.Helper()
